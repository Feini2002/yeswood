...
## Purpose
Define the layered frontend module structure after splitting the `public/app.js` monolith into native ES modules (`lib/`, `domain/`, `components/`, `pages/`, `styles/`, `dashboard/`) without adding a production bundler or changing business behavior.
## Requirements
